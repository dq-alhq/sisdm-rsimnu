...
export const buttonStyles = tv({
    base: [
        ...
        'relative isolate inline-flex items-center justify-center border border-(--btn-border) font-medium transition-transform hover:no-underline data-pressed:translate-y-px',
