'use client'
import type { ColorSliderProps, SliderOutputProps, SliderTrackProps } from 'react-aria-components/ColorSlider'
import { ColorSlider as PrimitiveColorSlider, SliderOutput, SliderTrack } from 'react-aria-components/ColorSlider'
