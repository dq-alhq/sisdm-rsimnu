        ...
        <span className='relative block' data-slot='control'>
            ...
            >
                {(segment) => (
                    <DateSegment
                        className={twJoin(
                            'inline shrink-0 rounded px-0 type-literal:px-0 py-0.5 text-fg tracking-wider caret-transparent outline-0 data-placeholder:not-data-focused:text-muted-fg sm:text-sm',
